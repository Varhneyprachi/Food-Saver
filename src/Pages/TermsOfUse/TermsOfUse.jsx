...
const TermsOfUse = () => {
  return (
    <div className="max-w-[1500px] mx-auto p-6 rounded-md  my-10">
      ...
      <p className="mb-4">
        Welcome to Food Saver! By accessing or using our website, you agree to comply
      ...
      <p>
        All content provided by Food Saver is for personal use only. You may not
        redistribute or republish without permission.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-2">4. Limitation of Liability</h2>
      <p>
        Food Saver is not responsible for any damages arising from the use or inability
